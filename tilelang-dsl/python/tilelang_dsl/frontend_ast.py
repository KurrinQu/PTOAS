...
_DMA_CALL_KEYWORDS: dict[str, frozenset[str]] = {
    ...
    "mte_l1_l0a": frozenset({"transpose", "start_row", "start_col"}),
    "mte_l1_l0b": frozenset({"transpose", "start_row", "start_col"}),
    "mte_l1_l0a_mx": frozenset({"start_row", "start_col"}),
    "mte_l1_l0b_mx": frozenset({"start_row", "start_col"}),
