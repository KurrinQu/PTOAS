...
## Purpose
Define the A5 backend mainline around `PTOToA5VM`, post-lowering fusion, and backend emission, while keeping A5 EmitC output available without legacy OP-Lib backend dependencies.
