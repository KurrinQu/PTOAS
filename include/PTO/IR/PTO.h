...
inline constexpr llvm::StringLiteral kPTOLoweringChoiceAttrName =
    "pto.lowering_choice";
inline constexpr llvm::StringLiteral kPTOVersionSelectionAppliedAttrName =
    "pto.version_selection_applied";
