...
"""PTODSL TileLib templates for pto.tgemv.mx variants."""
...
def template_tgemv_mx(lhs: pto.Tile, lhs_scale: pto.Tile, rhs: pto.Tile, rhs_scale: pto.Tile, dst: pto.Tile):
    ...
    _, k = lhs.valid_shape
    _, n = rhs.valid_shape
    pto.mad_mx(lhs.as_ptr(), rhs.as_ptr(), dst.as_ptr(), 1, n, k, sat="sat")
...
def template_tgemv_mx_acc(acc_in: pto.Tile, lhs: pto.Tile, lhs_scale: pto.Tile,
    ...
    _, k = lhs.valid_shape
    _, n = rhs.valid_shape
    pto.mad_mx_acc(lhs.as_ptr(), rhs.as_ptr(), dst.as_ptr(), 1, n, k, sat="nosat")
...
def template_tgemv_mx_bias(lhs: pto.Tile, lhs_scale: pto.Tile, rhs: pto.Tile,
    ...
    _, k = lhs.valid_shape
    _, n = rhs.valid_shape
    pto.mad_mx_bias(lhs.as_ptr(), rhs.as_ptr(), dst.as_ptr(), bias.as_ptr(), 1, n, k, sat="sat")
