...
// Test: A5 on-chip path generates correct sync ops for Cube→Vector flow.
// With DPS ops, no cross-section SSA deps exist, so the bridge is not triggered.
// This verifies pipeline correctness with on-chip-relevant address spaces.

func.func @a5_onchip_test(
...
// A5: set_intra_block(PIPE_FIX, 16)
// A5: __DAV_VEC__
...
// A3: ffts_cross_core_sync(PIPE_FIX, 16)
// A3: __DAV_VEC__
