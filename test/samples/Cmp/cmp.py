...
def build():
    with Context() as ctx:
        ...
        with Location.unknown(ctx):
            ...
            tile_view_i8 = pto.PartitionTensorViewType.get([32, 32], i8, ctx)
            tile_buf_i8 = pto.TileBufType.get([32, 32], i8, vec, [32, 32], cfg, ctx)
            ...
            with InsertionPoint(entry):
                ...
                tv2 = pto.MakeTensorViewOp(tv2_i8, arg2, [c32, c32], [c32, c1]).result
                ...
                tb2 = pto.AllocTileOp(tile_buf_i8).result
