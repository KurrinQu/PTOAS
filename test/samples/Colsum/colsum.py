...
def build():
    with Context() as ctx:
        ...
        with Location.unknown(ctx):
            ...
            tile_view_1_32 = pto.TileViewType.get([1, 32], f32, ctx)
            ...
            tile_buf_1_32 = pto.TileBufType.get([1, 32], f32, ub, [1, 32], cfg, ctx)
            ...
            with InsertionPoint(entry):
                ...
                sv2 = pto.SubviewOp(tile_view_1_32, tv2, [c0, c0], [c1, c32]).result
