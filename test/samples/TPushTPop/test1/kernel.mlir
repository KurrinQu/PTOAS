module attributes {pto.target_arch = "a5"} {
  func.func @matmul_tpush_tpop_print(
    ...
    func.call @matmul_tpush_tpop_print_cube(%gm_a, %gm_b, %c2v_consumer_buf)
      : (!pto.ptr<f32>, !pto.ptr<f32>, i32) -> ()
    func.call @matmul_tpush_tpop_print_vector(%c2v_consumer_buf) : (i32) -> ()
    return
  }

  func.func private @matmul_tpush_tpop_print_cube(
      %gm_a: !pto.ptr<f32>,
      %gm_b: !pto.ptr<f32>,
      %c2v_consumer_buf: i32)
  ...
  func.func private @matmul_tpush_tpop_print_vector(%c2v_consumer_buf: i32)
