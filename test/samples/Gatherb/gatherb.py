...
def build():
    with Context() as ctx:
        ...
        with Location.unknown(ctx):
            ...
            tile_view_u32 = pto.TileViewType.get([32, 32], u32, ctx)
            ...
            tile_buf_u32 = pto.TileBufType.get([32, 32], u32, ub, [32, 32], cfg, ctx)
            ...
            with InsertionPoint(entry):
                ...
                sv0 = pto.SubviewOp(tile_view_f32, tv0, [c0, c0], [c32, c32]).result
                sv1 = pto.SubviewOp(tile_view_u32, tv1, [c0, c0], [c32, c32]).result
