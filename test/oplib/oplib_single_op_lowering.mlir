...
// RUN: { ptoas %S/softmax_chain.pto --enable-op-fusion --pto-arch=a5 --print-ir-after-all -o /dev/null 2>&1; } | FileCheck %s --check-prefix=DEFAULT
...
// DEFAULT-LABEL: IR Dump After PTOInstantiateAndLowerToLibCall
// DEFAULT: func.func private @__pto_oplib_inst_l3_float_binary_elementwise_template_tmul_{{.*}}(
// DEFAULT: call @__pto_fused_group_0_0(
