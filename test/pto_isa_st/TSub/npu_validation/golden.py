...
CASES = {
    "tsub_float_64x64_64x64_64x64_64x64": {
        "dtype": "f32",
        "dst": (64, 64),
        "src0": (64, 64),
        "src1": (64, 64),
    ...
    "tsub_int32_64x64_64x64_64x64_64x64": {
        "dtype": "i32",
        "dst": (64, 64),
        "src0": (64, 64),
        "src1": (64, 64),
    ...
    "tsub_int16_64x64_64x64_64x64_64x64": {
        "dtype": "i16",
        "dst": (64, 64),
        "src0": (64, 64),
        "src1": (64, 64),
    ...
    "tsub_half_16x256_16x256_16x256_16x256": {
        "dtype": "f16",
        "dst": (16, 256),
        "src0": (16, 256),
        "src1": (16, 256),
    ...
    "tsub_half_16x64_16x128_16x128_16x64": {
        "dtype": "f16",
        "dst": (16, 64),
        "src0": (16, 128),
        "src1": (16, 128),
    ...
    "tsub_float_16x32_16x64_16x32_16x32": {
        "dtype": "f32",
        "dst": (16, 32),
        "src0": (16, 64),
        "src1": (16, 32),
    ...
    "tsub_int16_32x128_32x128_32x256_32x128": {
        "dtype": "i16",
        "dst": (32, 128),
        "src0": (32, 128),
        "src1": (32, 256),
    ...
    "tsub_int32_16x32_16x64_16x32_16x32": {
        "dtype": "i32",
        "dst": (16, 32),
        "src0": (16, 64),
        "src1": (16, 32),
    ...
    "tsub_half_16x64_16x128_16x128_16x63": {
        "dtype": "f16",
        "dst": (16, 64),
        "src0": (16, 128),
        "src1": (16, 128),
    ...
    "tsub_float_16x32_16x64_16x32_16x31": {
        "dtype": "f32",
        "dst": (16, 32),
        "src0": (16, 64),
        "src1": (16, 32),
    ...
    "tsub_int16_32x128_32x128_32x256_32x127": {
        "dtype": "i16",
        "dst": (32, 128),
        "src0": (32, 128),
        "src1": (32, 256),
    ...
    "tsub_int32_16x32_16x64_16x32_16x31": {
        "dtype": "i32",
        "dst": (16, 32),
        "src0": (16, 64),
        "src1": (16, 32),
