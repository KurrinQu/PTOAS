...
CASES = {
    "tsubs_float_32x128_32x64_32x64": {
        "dtype": "f32",
        "dst": (32, 128),
        "src": (32, 64),
        "valid": (32, 64),
    ...
    "tsubs_int32_31x256_31x128_31x128": {
        "dtype": "i32",
        "dst": (31, 256),
        "src": (31, 128),
        "valid": (31, 128),
    ...
    "tsubs_int16_15x192_15x192_15x192": {
        "dtype": "i16",
        "dst": (15, 192),
        "src": (15, 192),
        "valid": (15, 192),
    ...
    "tsubs_float_256x32_256x16_256x16": {
        "dtype": "f32",
        "dst": (256, 32),
        "src": (256, 16),
        "valid": (256, 16),
...
def main():
    ...
    if "scalar" == "binary":
        ...
        if "tsubs" in {"tadds", "tsubs", "tmuls", "tdivs"}:
