...
namespace mlir {
namespace pto {
#define GEN_PASS_DEF_PTOA5VMTRIVIALLOOPCANONICALIZE
...
struct PTOA5VMTrivialLoopCanonicalizePass
    : public pto::impl::PTOA5VMTrivialLoopCanonicalizeBase<
          PTOA5VMTrivialLoopCanonicalizePass> {
  using pto::impl::PTOA5VMTrivialLoopCanonicalizeBase<
      PTOA5VMTrivialLoopCanonicalizePass>::PTOA5VMTrivialLoopCanonicalizeBase;
...
std::unique_ptr<Pass> mlir::pto::createPTOA5VMTrivialLoopCanonicalizePass() {
  return std::make_unique<PTOA5VMTrivialLoopCanonicalizePass>();
}
